  ...
  return (
    <DefaultLayout>
      ...
      <div css={tw`py-6 text-right`}>
        <button tw="inline-flex flex-row items-center gap-1 text-gray-200 pl-3.5 pr-4 py-2 bg-gray-700 hover:bg-gray-600 transition-colors rounded-md">
      ...
      <SectionWrapper>
        <div tw="pb-10 mb-10 border-b border-solid border-gray-200">
          ...
          <p tw="dark:text-gray-400 mt-6">Innovative web developer with 6 years of experience in object-oriented programming, implementing design interfaces, testing, and debugging. Passionate about technology and learning new things</p>
        </div>
        <div tw="flex flex-col lg:flex-row lg:gap-28">
          <div tw="w-full lg:w-2/3">
            <h2 tw="font-medium text-2xl dark:text-gray-200 text-gray-800">Professional Experience</h2>
            {
                    ...
                    <div tw="relative block py-3 space-y-0.5">
                      <h3 tw="text-gray-700 font-medium dark:text-gray-200 text-lg">{company}</h3>
                      {
                        positions.map(({title, duration}) => (
                          <div tw="inline-flex items-start font-normal flex-col text-gray-600 md:flex-row md:items-center dark:text-gray-400"
          ...
          <div tw="w-full lg:w-1/3 space-y-5">
            <div tw="relative">
              <h2 tw="font-medium text-2xl dark:text-gray-200 text-gray-800 mb-2">Contact</h2>
              ...
              <div tw="space-y-1">
                ...
                <div tw="inline-flex items-center flex-row text-gray-700 dark:text-gray-200 space-x-1.5">
                  ...
                  <a href="https://oroalej.github.io/" rel="noreferrer" target="_blank" tw="hover:underline inline-flex flex-wrap flex-row items-start" className="group">
                    <span>https://oroalej.github.io/</span>
                    <ExternalLinkIcon tw="w-3.5 h-3.5 ml-1 opacity-0 group-hover:opacity-100" />
                  </a>
                </div>
              </div>
            </div>
            ...
            <div tw="relative">
              ...
              <div tw="w-52">
                <div tw="relative grid grid-cols-2 grid-flow-row py-3 gap-1.5 w-full text-gray-700 dark:text-gray-200 capitalize">
